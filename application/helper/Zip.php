...
/**
 *  NOTA: este helper es una copia modificada de la libreria Zip de CODEIGNITER CI 
 */
...
class Zip {
  ...
  //NOTA . este metodo pertenece al helper Download de CI
