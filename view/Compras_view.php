 ...
 * @author Desarrollo
 */
class Compras_view extends VistaBase{
    //put your code here
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            <div class="form-group col-md-3">
                                <label for="nombrePrdcto">Nombre Proveedor</label>
...
<script src="resource/js/VistaCompras/Compras.js?v=1" type="text/javascript"></script>
